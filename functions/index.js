...
exports.getReview = functions.https.onRequest((req, res) => {
  cors(req, res, () => {
    ...
    var reviews = [
      ...
      '[name] [was|was|were] so great to have stay at the apartment. [He was|She was|They were] a delight to host and I hope to have the opportunity to host [him|her|them] again someday.',
      ...
      '[name] [was|was|were] awesome to have as [a |a |]guest[||s] and did a great job on communicating on matters like check-in and check-out time. I can recommend [him|her|them] and I hope to have [him|her|them] again as a guest.',
      ...
      '[name] [was|was|were] great guest[||s] who highly respected house rules as well as my neighborhood. Also [He|She|They] cleaned up the bedroom same as it was at check in. Highly recommend guest[||s].',
      ...
      '[name] [was|was|were] FANTASTIC  guest[||s]. I absolutely loved having [him|her|them]. If [he|she|they] return to my city I hope [he|she|they] will come back and stay with me :-) I highly recommend to other hosts!',
